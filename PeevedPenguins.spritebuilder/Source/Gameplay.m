...
-(void) touchBegan:(CCTouch *)touch withEvent:(CCTouchEvent *)event {
    ...
    if (_currentPenguin == nil) {
        ...
        if (CGRectContainsPoint([_catapultArm boundingBox], touchLocation)) {
            ...
            _mouseJoint = [CCPhysicsJoint connectedSpringJointWithBodyA:_mouseJointNode.physicsBody bodyB:_catapultArm.physicsBody anchorA:ccp(0, 0) anchorB:ccp(14, 144) restLength:0.f stiffness:500.f damping:150.f];
